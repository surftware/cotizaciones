...
<head>
	...
	<link rel="mask-icon" href="assets/favicon/safari-pinned-tab.svg" color="#212529">
						...
						<div class="header-row">
							<div class="header-column justify-content-start">
								<span class="d-none d-sm-flex align-items-center">
									...
									Norte 84 A 6515 San Pedro el Chico, CDMX
								</span>
								<span class="d-none d-sm-flex align-items-center ml-4">
									<i class="fas fa-phone mr-1"></i>
									<a href="tel:+525511895621">5511894621</a>
								</span>
							</div>
								...
								<!--<ul class="nav">
									...
									<li class="nav-item">
										...
										<ul class="dropdown-menu dropdown-menu-right"
											...
											<li><a href="#" class="no-skin"><img src="img/blank.gif"
														class="flag flag-us" alt="English" /> English</a></li>
											<li><a href="#" class="no-skin"><img src="img/blank.gif"
														class="flag flag-es" alt="Español" /> Español</a></li>
											<li><a href="#" class="no-skin"><img src="img/blank.gif"
														class="flag flag-fr" alt="Française" /> Française</a></li>
										</ul>
									</li>
								</ul>-->
								<ul
